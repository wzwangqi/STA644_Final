...
This project sheds some light on the complicated situation of terrorist attacks with models that are easy to intepret. To improve the results of our models, we can take futher steps such as incorporating outside sources of data in the analysis and further tuning of the models. 
