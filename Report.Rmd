...
The forecasted trends seem to match up with our expectations of the number of terrorist attacks in the region. For instance, for Western Europe, due to influx of refugees in the area and complexity in the international politics, an increase in the number of terrorist incidents could be expected as indicated by the model. However, we need to keep in mind that terrorist attacks have complicated motives and are triggered by many elements and the models are merely a quick look at the trends to provide some insights in the matter. 
